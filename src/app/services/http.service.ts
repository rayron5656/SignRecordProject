...
export class HttpService {
  ...
  getAllLanguages() {
    return this._client.get('http://localhost:5050/api/v1/snapshot/snapshots',this.authTokenHeader);
  }
  ...
  getAllWordsByLanguage(language : string){
    this.setToken();
    console.log("'http://localhost:5050/api/v1/word/getAllWordsByLanguage/'" + language);
    return this._client.get('http://localhost:5050/api/v1/word/getAllWordsByLanguage/' + language,this.authTokenHeader);
  }
